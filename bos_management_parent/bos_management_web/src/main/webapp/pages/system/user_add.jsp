...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
			    ...
			    $.post("${pageContext.request.contextPath}/role/findAll.action", {}, function (data) {
                    $.each(data, function (i, e) {
                        var s = "<input type=\"checkbox\" name=\"roleIds\" value=\""+e.id+"\" /> " + e.name;
                        $("#roles").append(s);
                    })
                }, "json");
                    ...
                    if ($("#userForm").form("validate")) {
                        $("#userForm").form("submit", {
                            success : function (data) {
                                if ("success" == data) {
                                    location.href = "${pageContext.request.contextPath}/pages/system/user.jsp";
                                }
                            }
                        })
                    } else {
	...
	<body class="easyui-layout" style="visibility:hidden;">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="userForm" method="post" action="${pageContext.request.contextPath}/user/save.action">
