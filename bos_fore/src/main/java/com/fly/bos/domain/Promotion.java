...
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		if (titleImg != null && !titleImg.startsWith("http://localhost:8080")) {
			titleImg = "http://localhost:8080" + titleImg;
		}
		return titleImg;
	}
	...
	public String getDescription() {
        String replace = description.replace("src=\"/", "src=\"http://localhost:8080/");
        return replace;
    }
